...
public class DoublyLinkedList<T> {
    ...
    private SimpleNode<T> simpleNode;
    ...
    public DoublyLinkedList() {
        this.simpleNode = new SimpleNode<T>(this);
        clear();
    }
    ...
    public LinkedListNode<T> moveToFront(LinkedListNode<T> node) {
        return node.isEmpty() ? simpleNode : updateAndMoveToFront(node, node.getElement());
    }
